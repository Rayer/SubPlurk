...
public class EventManager {
	...
	/**
	 * Main routine that broadcast a message.
	 * @param messageType can be found by using EventBase.getID().
	 * @param ep message parameters, generated by EventBase.createParameters().
	 * @return
	 */
	boolean sendMessage(int messageType, EventParamBase ep) {
		ArrayList<EventProcessHandler> handlerList = mEventHandlerMap.get(messageType);
		if(handlerList == null)
			return false;
	...
	public boolean sendMessage(EventBase base) {
		return sendMessage(base.getID(), base.createParameters());
	}
